...
- integer and string constants, arithmetic, comparisons, local variables, simple loops, and conditionals
- recursive integer helper functions in the main package
- local imported packages that expose integer or string helper functions, including recursive helpers and package-level integer/string constants
