...
- integer/string/boolean constants, scalar package variables, arithmetic, comparisons, string `len(...)`, logical conditions, local variables, simple loops with `break`/`continue`, conditionals, and simple integer/expressionless `switch` statements
